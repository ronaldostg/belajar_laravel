...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
  ...
  <div class="col-lg-8">
        ...
        {{-- mengatasi cross side   --}}
          ...
          <div class="mb-3">
            ...
            {{-- cek apakah post title ada atau tidak  --}}
  ...
  <script>
    ...
    const randNum = Math.floor(Math.random() * 100);
      ...
      // console.log(title)  
      // apa yang dilakukan ketika title nya diubah
      fetch('/dashboard/posts/checkSlug?title=' + title.value+'-'+randNum).then(response => response.json()).then(data => slug.value = data.slug)
